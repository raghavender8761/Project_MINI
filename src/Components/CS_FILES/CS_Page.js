...
import "./AIML.css"
import sunithamam from "../../img/sunithamam.jpg"
function CS_Page() {
  return (
    <>
    <div class="jumbotron-a jumbotron-fluid-a page-header position-relative " style={{marginBottom: "50px"}}>
        <div class="container text-center py-5">
            <h1 class="text-violet display-1">CSE-CS</h1>
        </div>
        <div class="container text-center py-5">
            <h6 class="text-violet">Computer Science Engineering-Cyber Security</h6>
        </div>
    </div>
    <marquee class="css1">Welcome To Department Of EMERGING TECHNOLOGIES - <strong>CSE-CS</strong></marquee>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3"><a href="/CS/faculty">Skilled Instructors</a></h5>
                        <br></br>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3"><a href="/CS/Infrastructure">Infrastructure</a></h5>
                        <br></br>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        ...
                        <h5 class="mb-3"><a href="/CS/Course_Outcomes">Course Structure and Outcomes</a></h5>
                        <p></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item text-center pt-3">
                    <div class="p-4" >
                        ...
                        <h5 class="mb-3"><a href="/CS/student_achievement">Student Achievements</a></h5>
                        <br></br>
                    </div>
                </div>
             </div>
...
<div class="d-flex justify-content-center"><img src={sunithamam} class="myimg" alt="" /></div>
<br></br>
...
<div class="section-title text-center position-relative mb-4">
    ...
    <div class="container">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        <h5 class="mb-3"><a href="">-- Associate Professors</a></h5>
                    </div>
                </div>
        </div>
    ...
    <div class="container">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        <h5 class="mb-3">-- Sr.Assistant Professors</h5>
                    </div>
                </div>
        </div>
    ...
    <div class="container">
                <div class="service-item text-center pt-3">
                    <div class="p-4">
                        <h5 class="mb-3">-- Assistant Professors</h5>
                    </div>
                </div>
        </div>
